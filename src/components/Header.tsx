    ...
    <>
      <div className="w-full bg-gradient-to-r from-[#8a9b6e] via-[#d4a762] to-[#6b8c85] shadow-md text-white">
        <div className="max-w-7xl mx-auto flex items-center gap-4 py-3 px-6">
          <img src="/qcu-logo.png" alt="QCU Logo" className="h-10" />
          <img src="/cwts-logo.png" alt="CWTS Logo" className="h-10" />
          <img src="/group-logo.png" alt="Group Logo" className="h-10" />
          <img src="/talipapa-logo.png" alt="Talipapa Logo" className="h-10" />
